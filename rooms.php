...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center" style="font-family: times new roman, serif;">ROOMS</h2>
    <div class="h-line bg-dark" style="width: 8%; height: 1.5px; margin: 0 auto;"></div>
  </div>
