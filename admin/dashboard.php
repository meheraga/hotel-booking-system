...
<body class="bg-light">
  ...
  <?php 
    ...
    $current_bookings = mysqli_fetch_assoc(mysqli_query($con,"SELECT 
      ...
      $current_bookings = mysqli_fetch_assoc(mysqli_query($con,"SELECT
      COUNT(CASE WHEN booking_status='booked' AND arrival=0 THEN 1 END) AS `new_bookings`,
      COUNT(CASE WHEN booking_status='booked' THEN 1 END) AS `total_active_bookings`,
            ...
            <option value="4">All time</option>
                  ...
                  <div class="col-md-3 mb-4">
                      <div class="card text-center text-success p-3">
                          ...
                          <h1 class="mt-2 mb-0"><?php echo $current_bookings['new_bookings'] + $current_bookings['cancelled_bookings'] + $current_bookings['total_active_bookings'] - $current_bookings['new_bookings'] ?></h1>
                      </div>
                  </div>
                  <div class="col-md-3 mb-4">
                      <div class="card text-center text-info p-3">
                          <h6>Active Bookings</h6>
                          <h1 class="mt-2 mb-0"><?php echo $current_bookings['total_active_bookings'] ?></h1>
                      </div>
                  </div>
                  <div class="col-md-3 mb-4">
